...
class Ui_Preferences(object):
    ...
    def retranslateUi(self, Preferences):
        ...
        self.labelPassword.setText(QtGui.QApplication.translate("Preferences", "Set an application-wide password to protect account-related functionalities against 