...
class Ui_Preferences(object):
    ...
    def retranslateUi(self, Preferences):
        ...
        self.labelKeySecret.setText(QtGui.QApplication.translate("Preferences", "Insert your market\'s (e.g. MtGox) API key here. If you don\'t have an API key yet, you should be able to generate one on your market\'s website.", None